            ...
            <div className="mt-7">
              ...
              <label className="mt-2 flex cursor-pointer gap-3 rounded-xl border border-slate-200 p-4">
                ...
                <span>
                  ...
                  <small className="text-slate-500">
                    Your order stays pending until our team verifies the
                    transfer
                  </small>
                </span>
              </label>
              {paymentMethod === "bank" && (
                <p className="mt-3 rounded-xl bg-amber-50 p-3 text-xs leading-5 text-amber-800">
                  Bank details and the order reference will be confirmed by our
                  support team. Do not send funds to an unverified account.
                </p>
              )}
            </div>
