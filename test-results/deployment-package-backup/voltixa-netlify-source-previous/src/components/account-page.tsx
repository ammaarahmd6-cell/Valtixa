          ...
          <div className="min-w-0">
            ...
            {section === "reviews" && (
              <>
                <Title
                  title="My reviews"
                  sub="Reviews and products awaiting feedback"
                />
                <Empty
                  icon={Star}
                  title="No reviews yet"
                  text="Delivered products will appear here for review."
                />
              </>
            )}
                ...
                <div className="space-y-3">
                  {[
                    [
                      ...
                      "Welcome to Voltixa. Configure Supabase to enable persistent notifications.",
                    ],
                    [
                      "Volt Week is live",
                      "Explore this week’s limited-time catalog offers.",
                    ],
                  ].map(([a, b]) => (
                    <div
                      key={a}
...
function Complaints() {
  function submit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    toast.success("Demo complaint captured. Configure Supabase to persist it.");
